...
theTime.add({
	...
	update: function(percent) {
		...
		//nút dưới
		document.querySelector('.container .sup').innerHTML= "Em yêu chị^^ " + (thePercent+9899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Úa Òa^^Hi chị thối của em Moaaaaaa :';
document.querySelector('.Description .modal-body').innerHTML = 'Em mún ôm chị vào lòng !!! Cho em được sửa sai nhé:(( <i class="fas fa-heart"></i> ';
